...
def tag_ax(ax, text, pos='topright'):
    if isinstance(pos, tuple):
        ax.text(*pos, text, fontweight='bold', fontsize=16,
                va='center', ha='center', transform=ax.transAxes, c=BLACK_NORD,
                bbox={'boxstyle': 'square', 'color': WHITE_NORD})
        return None
    ...
    ax.text(x, y, text, fontweight='bold', fontsize=16,
            ha=ha, va=va, transform=ax.transAxes, c=BLACK_NORD,
            bbox={'boxstyle': 'square', 'color': WHITE_NORD})
